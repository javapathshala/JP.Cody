...
public class CreatePDF {
	...
	private void showPdf() {
		...
		try {
			...
			BaseFont verdana = BaseFont.createFont("C:\\WINDOWS\\FONTS\\VERDANA.TTF", BaseFont.CP1252, BaseFont.NOT_EMBEDDED);
			Font header = new Font(verdana, 12, Font.BOLD, new BaseColor(0, 51, 102));
			Font subhead = new Font(verdana, 8, Font.BOLD, new BaseColor(0, 51, 102));
			Font normal = new Font(verdana, 7, Font.NORMAL);
			Font bold = new Font(verdana, 7, Font.BOLD);

			// header
		Image image = Image.getInstance("Dimit.jpg");
			...
			document.add(new Phrase("Transaction Report on 22/10/2009 at 14:14:14 IST" + LINE_SEP, subhead));
			...
			setCellProperties("", normal);
			addTableRight();
			setCellProperties("Last Night's Closing Cleared for Interest:", bold);
			addTableRight();
